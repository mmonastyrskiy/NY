...
const DISPLAY_NAMES = {
    ...
    "Новогодний пряник": "🍪 Пряник размером с Луну",
    "Подарочный сертификат": "🎫 Билет в страну чудес",
    "Билет в кино": "🎬 Премьера 'Ёлки 9999'",
    "Книга с автографом": "📚 Книга мудрости от Совы",
    "Фирменная кружка": "☕ Кружка 'Я люблю работу'",
    "Набор конфет": "🍬 Конфета счастья (не делится)",
    "Ёлочная игрушка": "🎄 Шар предсказаний",
    "Сувенирная лошадка": "🐎 Лошадка года (талисман)",
    "Плед для зимних вечеров": "🧣 Плед 'Обнимашка 3000'",
    "Годовой запас хорошего настроения": "😊 Настроение на год вперед",
    "Футболка с новогодним принтом": "👕 Футболка 'Я Деду Морозу родственник'",
    "Набор для создания имбирных пряников": "🧁 Кондитерская фабрика на кухне",
    "Гирлянда для праздничного настроения": "💡 Гирлянда 'Миллион огней'",
    "Термос для зимних прогулок": "🧊 Термос 'Вечный чай'",
    "Настольная игра для компании": "🎲 Игра 'Кто проиграет - моет посуду'",
    "Ароматическая свеча 'Новый год'": "🕯️ Свеча 'Запах мандаринов и ёлки'",
    "Флеш-карта с новогодними фильмами": "💾 Флешка 'Кинотеатр в кармане'",
    "Набор елочных шаров": "🔮 Шары 'Взгляд в будущее'",
    "Пазл с новогодним пейзажем": "🧩 Пазл 'Найди Санту'",
    "Календарь на следующий год": "📅 Календарь '365 поводов для праздника'",
    
    // Дополнительные популярные призы
    "Бутылка шампанского": "🍾 Шампанское 'Пузырьки радости'",
    "Коробка шоколада": "🍫 Шоколад 'Сладкие грезы'",
    "Набор чая/кофе": "🌿 Набор 'Бодрое утро'",
    "Сертификат в ресторан": "🍽️ Ужин 'По-королевски'",
    "Билет на концерт": "🎤 Концерт 'Звезды для вас'",
    "Фотосессия": "📸 Фото 'Как с обложки'",
    "Спортивный инвентарь": "🏓 Спорт 'Олимпийские надежды'",
    "Набор для рукоделия": "🧵 Набор 'Золотые руки'",
    "Электронная книга": "📱 Книга 'Библиотека в ладони'",
    "Наушники": "🎧 Наушники 'Мир в ушах'",
    "Внешний аккумулятор": "🔋 Батарейка 'Вечный заряд'",
    "USB-флешка": "💿 Флешка 'Секретный сейф'"
};
